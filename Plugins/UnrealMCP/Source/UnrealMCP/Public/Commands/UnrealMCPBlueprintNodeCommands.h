...
private:
    ...
    TSharedPtr<FJsonObject> HandleConnectBlueprintFunctionNodes(const TSharedPtr<FJsonObject>& Params);
    TSharedPtr<FJsonObject> HandleAddNodeToFunctionGraph(const TSharedPtr<FJsonObject>& Params);
};